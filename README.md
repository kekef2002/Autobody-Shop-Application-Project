...
1. **Clone the Repository**:
   ```bash
   git clone https://github.com/yourusername/autobody-shop-app.git
   ```
...
5. **Optional (Figma Design)**:
   - If you want to adjust or create UI designs, access the Figma design files here: [Figma Project Link](https://www.figma.com/yourdesign).
...
- **[Your Name]** – Project Lead, Backend Development, Azure Integration
- **[Teammate 1]** – Frontend Development, JavaFX Design
- **[Teammate 2]** – UI/UX Designer, Figma Prototyping
- **[Teammate 3]** – Database and Reporting, MySQL
